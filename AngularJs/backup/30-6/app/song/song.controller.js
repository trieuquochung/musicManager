(function() {
  ...
  angular.module('project')
    .controller('songController', ['songService','mainService','$mdDialog', '$scope', '$location', '$rootScope',
      function (songService,mainService, $mdDialog, $scope, $location, $rootScope) {
        ...
        vm.selectedMenu = mainService.selectedMenu;
        ...
        vm.breadcrumb = {
          home: {
            ...
            onClick: function () {
              $location.url('/');
              mainService.selectedMenu = mainService.menu.song;
            }
          },
          song: {
            title: 'Songs',
