(function() {
  ...
  angular.module('project')
    .controller('playlistController', ['$location','mainService','playlistService','songService', '$mdDialog',
      function ($location, mainService, playlistService, songService, $mdDialog) {
